        ...
        VStack {
            ...
            HSplitView{
                GeometryReader{proxy in
                    ScrollView{
                        LazyVGrid(columns: Array(repeating: GridItem(.flexible(),spacing: 5), count: proxy.size.width < 750 ? 2 : proxy.size.width < 900 ? 3 : proxy.size.width < 1100 ? 4 : 5)) {
